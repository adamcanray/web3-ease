...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex flex-col justify-center items-center relative">
      <button
        onClick={() => router.push("/")}
        className="absolute top-3 left-3 h-10 w-10 flex items-center justify-center rounded-full bg-gray-950 hover:bg-gray-900 active:bg-gray-900"
      >
        <svg
      ...
      <p className="text-base font-semibold text-white">{ensName ?? address}</p>
      <p className="text-base font-light text-white">Balance</p>
      <p className="text-base font-semibold text-white">{balance?.formatted}</p>
